...
+ mainSeg _legacy.m: steps from classification result by CNN to segmentation (grid parameter search for watershed segmentation) including skeleton based split-merger metrics
+ visSeg _legacy.m:  visualize a given segmentation, e.g. object chains, segMovies, errorMovies = detected merger errors etc.
