 ...
 */
void watershed_threeTimes3D(unsigned short int *cnn_x, unsigned short int *cnn_y, unsigned short int *cnn_z, int *lab)
{
 ...
 * [labelled_image] = watershed_threeTimes3D(cnn_x, cnn_y, cnn_z, marker_image, n_levels, threshold);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    //print_queues();
    //    return;
    watershed_threeTimes3D(cnn_x, cnn_y, cnn_z, lab);
    //print_queues();
