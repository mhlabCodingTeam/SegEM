...
param.outputSubfolder = 'segmentations3/';
param.figureSubfolder = 'figures3/';
...
param.pR{2,2} = {-0.6:0.025:-0.4 0:50:100};
param.pR{3,2} = {[]  []};
param.pR{4,2} = {-0.4:0.025:-0.2 0:50:50};
param.pR{5,2} = {0:0.025:0.2 0:50:50};
