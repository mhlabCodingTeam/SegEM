...
param.outputSubfolder = ['seg2' date filesep];
...
param.pR{2,2} = {[] []};
param.pR{3,2} = {[] []};
param.pR{4,2} = {-0.5:0.02:-0.1 0:20:200};
param.pR{5,2} = {-0.05:0.02:0.35 0:20:200};
% Set parameter for evaluation
param.nodeThres = 2; % Number of nodes within object that count as connection
